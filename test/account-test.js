...
(async () => {
  ...
  // A backup is one archive holding the database and the uploaded files.
  ok('and it really is a ZIP archive', body.slice(0, 2).toString() === 'PK', body.slice(0, 4).toString('hex'));
